...
function renderGlobalView() {
    ...
    let html = `
        <h2 style="font-size: 2rem; color: #fff; margin-bottom: 2rem; text-align: center;">Resumen Ejecutivo por Centro de Distribución</h2>
        ...
        html += `
            <div class="stat-card glass-panel" style="flex-direction: column; align-items: flex-start; gap: 1rem;">
                <div style="display: flex; align-items: center; gap: 1rem; width: 100%; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 1rem;">
                    ...
                    <h3 style="font-size: 1.5rem; color: #fff; margin: 0;">${cd}</h3>
                </div>
                ...
                <div style="width: 100%; display: flex; justify-content: space-between; margin-top: 0.5rem;">
                    ...
                    <strong style="color: #fff; font-size: 1.2rem;">${uniqueOrders}</strong>
                </div>
