...
document.addEventListener('DOMContentLoaded', () => {
 ...
 // Set orders to finalOrders so the rest of the function renders correctly!
        ...
        if (statSales) {
            statSales.innerHTML = `
        <span class="numero-grande" style="font-size: 2rem; font-weight: bold; color: #0f172a;">${cajasTotal.toLocaleString('en-US', { maximumFractionDigits: 0 })} <small style="font-size: 60%; color: #64748b;">CA</small></span>
        <span class="numero-mediano" style="font-size: 1.2rem; font-weight: bold; color: #334155; margin-left: 10px;">${hlTotal.toLocaleString('en-US', { maximumFractionDigits: 2 })} <small style="font-size: 60%; color: #94a3b8;">HL</small></span>
    `;
        }
