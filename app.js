document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderDashboard(key, role) {
        ...
        if (uniqueBlockedOrders > 0) {
            ...
            statOrdersSub.innerHTML = `Se tiene <span style="font-weight:700;">${uniqueBlockedOrders}</span> para gestionar liberacion! (Ped. Bloqueados)`;
        ...
        if (rejectedClients.size > 0) {
            ...
            clientSubHtml += `<div style="color: #B91C1C;">Se tiene <span style="font-weight:700;">${rejectedClients.size}</span> para reforzar recepcion de pedido. (Rechazos)</div>`;
...
window.setAdminFilter = function(filter) {
    ...
    function renderGlobalView() {
        ...
        if (!container) {
            console.error("No se encontro global-view-container");
            return;
        }
        ...
        try {
            ...
            const activeFilter = window.adminGlobalFilter || 'Todas';
