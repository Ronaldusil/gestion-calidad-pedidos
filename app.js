document.addEventListener('DOMContentLoaded', () => {
    ...
    function processExcelData(workbook, rawBytes) {
        ...
        headerRow.forEach((cell, index) => {
            ...
            if (normCell === normalizeStr("N pedido") || normCell.includes("PEDIDO")) colMap[index] = "N pedido";
            ...
            if (normCell === normalizeStr("CPag") || normCell.includes(normalizeStr("Pago"))) colMap[index] = "CPag";
            if (normCell === normalizeStr("AP") || normCell.includes(normalizeStr("Bloqueado"))) colMap[index] = "AP";
    ...
    function renderDashboard(key, role) {
        ...
        orders.forEach((order, index) => {
            ...
            const bloqueado = (apValue === "C" || apValue === "BLOQUEADO") ? "Bloqueado" : "";
            ...
            tr.innerHTML = `
                ...
                <td>
                    ...
                    <div class="client-id">Sup: ${order["Supervisor Venta"] || "N/A"}</div>
                </td>
                <td>
                ...
                <td>
                    <strong>${caja}</strong> <span style="font-size: 0.8em; color: var(--success);">CA</span><br>
                    <strong>${hl}</strong> <span style="font-size: 0.8em; color: var(--accent-primary);">HL</span>
                </td>
                <td>
