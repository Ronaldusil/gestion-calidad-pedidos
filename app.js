document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderDashboard(zv) {
        ...
        const uniqueBlocked = new Set(orders.filter(o => String(o["ST"] || "").trim().toUpperCase() === "B").map(o => o["Nº pedido cliente"])).size;
        ...
        orders.forEach((order, index) => {
            ...
            let asegurarPago = order["Asegurar pago"] || "";
            if (asegurarPago === "N/A" || asegurarPago.trim() === "") asegurarPago = "";
            
            const stValue = String(order["ST"] || "").trim().toUpperCase();
            const bloqueado = (stValue === "B") ? "Bloqueado" : "";
