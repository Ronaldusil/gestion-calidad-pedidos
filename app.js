document.addEventListener('DOMContentLoaded', () => {
    ...
    function processExcelData(data) {
        ...
        if (globalData.length === 0 && data.length > 0) {
            alert("AVISO: El Excel cargó correctamente, pero NINGUNA fila cumple con las reglas que pediste (TpMt = FERT y ClVt = ZPP3, ZPP5 o ZPPV). Por eso la tabla está vacía.");
        }
