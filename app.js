        ...
        function renderGlobalView() {
            ...
            globalOrders.forEach(o => {
                ...
                if (fechaStr.length >= 10) {
                    ...
                    if (parts.length === 3) {
                        ...
                        displayDate = parts[0] + '/' + parts[1].padStart(2, '0');
                    }
                }
            ...
            const html = `
                ...
                <div class="admin-top-section">
                    <div class="capacidades-container">
                    ...
                    <div class="admin-prop-table-container">
                        <h3 class="admin-table-title" style="text-align: center; margin-bottom: 8px;">Avance por CD x día</h3>
