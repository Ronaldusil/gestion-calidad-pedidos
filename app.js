      ...
      <span class="cat-valor">${categoryStats[cat].cajas.toLocaleString('en-US', {maximumFractionDigits:0})} <sub>CA</sub></span>
        ...
        paginatedOrders.forEach((order, index) => {
            ...
            // Producto: Material + Marca + Categoria
             ...
             padding:2px 6px; border-radius:4px; margin-right:4px;">${marca}</span>` : ''}${categoria ? `<span style="background:rgba(0,0,0,0.05); padding:2px 6px; border-radius:4px;">${categoria}</span>` : ''}`;
            ...
            order.lineItems.forEach(item => {
                ...
                const material = item["Denominacion"] || item["Producto"] || "Desconocido";
                const um = item["UM"] || "";
