    ...
    function processArrayBuffer(data) {
        ...
        try {
            ...
            if (success) {
                ...
                if (dFilter) dFilter.value = maxExecutionDateStr;
        ...
        if (filterDateStr || searchStr) {
            baseOrders = orders.filter(order => {
                ...
                if (filterDateStr) {
                    ...
                    matchDate = (orderCreado === filterDateStr) && (!orderEntrega || orderEntrega === expectedEntrega);
                }
    ...
    renderGlobalView();
        ...
        function renderGlobalView() {
            ...
            filteredOrders.forEach(o => {
                ...
                if (isTargetDaySic && matchesCreado) {
                    const horaStr = String(o["Hora"] || "");
                    let hour = "00";
                    if (horaStr) {
                        const hMatch = horaStr.match(/^(\d{1,2}):/);
