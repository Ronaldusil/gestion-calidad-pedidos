    ...
    function renderDashboard(key, role) {
        ...
        orders.forEach((order, index) => {
            ...
            tr.innerHTML = `
                ...
                <td>
                    <div class="date-badge" style="background: rgba(168, 85, 247, 0.2); color: #c084fc;">${dateCreation}</div>
                </td>
                <td>
                    <div class="date-badge" style="background: rgba(168, 85, 247, 0.2); color: #c084fc;">${String(order["Tipo de Pago"] || "Sin Tipo")}</div>
                </td>
                <td>
                ...
                <td>
                    <div style="display:flex; flex-direction:column; gap:4px;">
                        ${prepago ? `<div class="date-badge" style="background: rgba(239, 68, 68, 0.2); color: #f87171; font-weight: bold; border: 1px solid rgba(239, 68, 68, 0.5);">${prepago}</div>` : ''}
                ...
                <td>
                    ${rechazo && rechazo !== "N/A" ? `<div class="date-badge" style="background: rgba(239, 68, 68, 0.1); color: #ef4444; border: 1px solid rgba(239, 68, 68, 0.4);">${rechazo}</div>` : ''}
                </td>
                <td class="text-right">
