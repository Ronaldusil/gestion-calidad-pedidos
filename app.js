        ...
        function renderGlobalView() {
            ...
            globalOrders.forEach(o => {
                ...
                if (fechaStr.includes('-')) {
                    ...
                    if (parts.length >= 3) {
                        displayDate = parts[2].padStart(2, '0') + '/' + parts[1].padStart(2, '0');
                    }
                } else if (fechaStr.includes('/')) {
                    const parts = fechaStr.split('/');
                    if (parts.length >= 3) {
                        displayDate = parts[0].padStart(2, '0') + '/' + parts[1].padStart(2, '0');
                    }
                }
            ...
            filteredOrders.forEach(o => {
                ...
                if (fechaStr.includes('-')) {
                    const parts = fechaStr.split('-');
                    if (parts.length >= 3) displayDate = parts[2].padStart(2, '0') + '/' + parts[1].padStart(2, '0');
                } else if (fechaStr.includes('/')) {
                    const parts = fechaStr.split('/');
                    if (parts.length >= 3) displayDate = parts[0].padStart(2, '0') + '/' + parts[1].padStart(2, '0');
                }
