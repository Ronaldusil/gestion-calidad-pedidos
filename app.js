    ...
    renderGlobalView();
        ...
        function renderGlobalView() {
            ...
            globalOrders.forEach(o => {
                ...
                // Process Date for table and charts
                let displayDate = window.formatearFechaExcel ? window.formatearFechaExcel(fechaStr) : fechaStr;
                
                // Process Hour for SIC (Only next working day)
                const today = new Date();
                let daysToAdd = 1;
                if (today.getDay() === 6) daysToAdd = 2; // Sat -> Mon
            ...
            sortedTableDates.forEach(d => {
                ...
                tableRows += `
                    <tr>
                        ...
                        <td>${td.Arequipa.hl.toLocaleString('en-US', {maximumFractionDigits:0})}</td>
                        <td>${td.Arequipa.cli.size}</td>
                        <td>${td.Tacna.hl.toLocaleString('en-US', {maximumFractionDigits:0})}</td>
                        <td>${td.Tacna.cli.size}</td>
                        <td style="font-weight: bold; color: #DC2626;">${td.Ilo.hl.toLocaleString('en-US', {maximumFractionDigits:0})}</td>
                        <td>${td.Ilo.cli.size}</td>
                    </tr>
                `;
            });
            ...
            const html = `
                ...
                <div class="graficos-container">
                    <div class="card">
                        ...
                        <div class="grafico-wrapper" style="overflow-x: auto; overflow-y: hidden; padding-bottom: 10px;">
