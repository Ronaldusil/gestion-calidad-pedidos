...
function renderGlobalView() {
    ...
    if (activeFilter === 'Todas') {
        ...
        const cdKey = `CD ${activeFilter}`; // "CD Arequipa", "CD Tacna", "CD Ilo"
        // Need to correctly map Ilo -> ILO if necessary, but cdsData keys are exact.
...
// Funci�n global para el bot�n de las tarjetas
