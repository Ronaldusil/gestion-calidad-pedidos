...
window.setAdminFilter = function(filter) {
    ...
    function renderGlobalView() {
        ...
        if (!container) {
            console.error("No se encontró global-view-container");
            return;
        }
        ...
        try {
            ...
            // APLICAR HTML PRIMERO (PARA QUE LA PÁGINA NUNCA QUEDE VACÍA)
            container.innerHTML = html;

            // LUEGO INICIALIZAR EL GRÁFICO CON UN TRY-CATCH INDEPENDIENTE
            try {
                if (typeof Chart !== 'undefined') {
                    ...
                    console.warn("Chart.js no está cargado. El gráfico no se mostrará, pero la tabla sí.");
                }
            } catch (chartErr) {
                console.error("Error al renderizar el gráfico Chart.js:", chartErr);
            }
        } catch (e) {
            ...
            container.innerHTML = `<div style="padding: 2rem; color: #DC2626; background: #FEE2E2; border-radius: 8px;">
                <h3>Oops! Ocurrió un error al cargar la vista global.</h3>
                <p>${e.message}</p>
            </div>`;
        }
    }
