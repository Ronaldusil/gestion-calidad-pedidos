...
let globalData = [];
    ...
    function processExcelData(workbook, rawBytes) {
        ...
        if (currentUserRole === 'supervisor') {
            const supervisorNameMatch = currentUserZV;
        ...
        if (statSales) {
            statSales.innerHTML = `
                <div style="display: flex; align-items: baseline; gap: 12px; margin-top: 4px;">
                    <div>
                        <span style="font-size: 2.2rem; font-weight: 700; color: #1e293b; line-height: 1;">${cajasTotal.toLocaleString('en-US', { maximumFractionDigits: 0 })}</span>
                        <span style="font-size: 0.75rem; font-weight: 600; color: #64748b;">CA</span>
                    </div>
                    <div>
                        <span style="font-size: 1.6rem; font-weight: 700; color: #334155; line-height: 1;">${hlTotal.toLocaleString('en-US', { maximumFractionDigits: 2 })}</span>
                        <span style="font-size: 0.75rem; font-weight: 600; color: #94a3b8;">HL</span>
                    </div>
                </div>`;
        }
