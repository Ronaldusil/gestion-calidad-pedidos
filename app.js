document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadDataAutomatically() {
        ...
        try {
            ...
            // Extraer TODO el excel como una matriz 2D plana (sin adivinar llaves)
    ...
    function processExcelData(rawData) {
        ...
        // Buscar la fila que tenga más coincidencias con nuestras llaves (para saltar títulos o filas vacías)
        ...
        if (headerRowIndex === -1 || bestMatchCount === 0) {
            alert("AVISO: No pude encontrar la fila de encabezados en el Excel. ¡Asegúrate de que el archivo tenga las columnas TpMt, ClVt, ZV, etc.!");
            return;
        }
