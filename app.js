document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderDashboard(key, role) {
        ...
        if (statSales) {
            statSales.innerHTML = `${cajasTotal.toLocaleString('en-US', { maximumFractionDigits: 2 })} <span class="metric-unit">CA</span><br>${hlTotal.toLocaleString('en-US', { maximumFractionDigits: 2 })} <span class="metric-unit">HL</span>`;
        }
