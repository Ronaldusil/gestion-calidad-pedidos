...
function renderGlobalView() {
    ...
    let html = `
        <h2 style="font-size: 2rem; color: var(--text-primary); margin-bottom: 2rem; text-align: center;">Resumen Ejecutivo por Centro de Distribución</h2>
    ...
    cds.forEach(cd => {
        ...
        html += `
            <div class="stat-card glass-panel" style="flex-direction: column; align-items: flex-start; gap: 1rem;">
                <div style="display: flex; align-items: center; gap: 1rem; width: 100%; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 1rem;">
                ...
                <div style="width: 100%; display: flex; justify-content: space-between;">
                    ...
                    <strong style="color: #34d399; font-size: 1.2rem;">${totalCajas.toLocaleString('en-US', { maximumFractionDigits: 2 })}</strong>
                </div>
                
                <div style="width: 100%; display: flex; justify-content: space-between;">
                    <span style="color: var(--text-secondary);">Pedidos Bloqueados:</span>
                    <strong style="color: #f87171; font-size: 1.2rem;">${uniqueBlocked}</strong>
                </div>
                
                <button class="btn-primary" style="width: 100%; margin-top: 1rem; justify-content: center;" onclick="selectCD('${cd}')">
